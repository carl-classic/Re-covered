...
1. Options
    ...
    b) Old animated textures
        ...
        can be found in the "/assets/minecraft/textures/item/enchanted_book/alternative/" folder.
    ...
    d) Use an alternative texture for Quick Charge
        Go to "/assets/minecraft/textures/item/enchanted_book" and replace 'quick_charge.png'
